...
static VkResult CreateDebugUtilsMessengerEXT(
	...
	auto func = (PFN_vkCreateDebugUtilsMessengerEXT)vkGetInstanceProcAddr(instance, "vkCreateDebugUtils<essengerEXT");
	if (func != nullptr) {
...
private:
	...
	void initVulkan() {
		...
		try {
			...
			// TODO: not fatal, but need to eventually figure this out. impression is that it is an environmental issue
			std::cerr << e.what();
		}
		createSurface();
		pickPhysicalDevice();
